...
public class TestJTAMultipleDataSource
{
    ...
    public void execTest(boolean useFakeUserTxn,DataSourceFactoryOfLoaderJTA dsLoader,String jtaProvider)
    {
        ...
        DataSourceLoaderJTA dsJTAFactory1 = dsLoader.createDataSourceLoaderJTA(jtaProvider);
        DataSourceLoaderJTA dsJTAFactory2 = dsLoader.createDataSourceLoaderJTA(jtaProvider);
        
        CreateDBModel.createDB(dsJTAFactory1.getDataSource());        
        CreateDBModel.createDB(dsJTAFactory2.getDataSource());
